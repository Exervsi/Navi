...
namespace Navi.Core.SystemExtensions.String
{
    ...
    internal static class PathBuilders
    {
        /// <summary>
        ...
        internal static XElement? LoadXml(string path, string methodName)
        { 
        ...
        internal static string BuildChildUrl(InfoItems.InfoItem item)
        {
            if (item is DocuTree root)
                return "./";
